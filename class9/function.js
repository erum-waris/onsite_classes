...
console.log(Result);
//creating function
function placestoVisit(places, train) {
    let Visitplaces = places;
...
function admitCard(name, fatherName, age, course = "Graphic Designing", //default value
rollNo, email, contactNo) {
...
studentData.forEach(student => {
    admitCard(student.name, student.fatherName, student.age, student.course, student.rollNo, student.email, student.contactNo);
});
